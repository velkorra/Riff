        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tracks_AspNetUsers_AddedById",
                        column: x => x.AddedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tracks_Rooms_RoomId",
                        column: x => x.RoomId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Vote", x => new { x.UserId, x.TrackId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tracks_AddedById",
                table: "Tracks",
                column: "AddedById");

            migrationBuilder.CreateIndex(
                name: "IX_Tracks_RoomId",
                table: "Tracks",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_Vote_TrackId",
                table: "Vote",
                column: "TrackId");
        }
